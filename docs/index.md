...
- Connect to BigQuery, Amazon Redshift, Snowflake, PostgreSQL, or Databricks
...
- [Configuring Warehouses](guides/configuring-warehouse.md) — BigQuery, Redshift, Snowflake, PostgreSQL, Databricks setup
